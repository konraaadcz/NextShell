...
import main.java.net.nextshell.panel.TerminalPanel;
import javax.swing.*;
import java.awt.*;
import main.java.net.nextshell.routes.AutoShutdown;
...
public class TerminalFrame extends JFrame {
    ...
    public TerminalFrame() {
        ...
        autoShutdown = new AutoShutdown(this);
    ...
    private void openNewWindow() {
        SwingUtilities.invokeLater(() -> {
            TerminalFrame newFrame = new TerminalFrame();
